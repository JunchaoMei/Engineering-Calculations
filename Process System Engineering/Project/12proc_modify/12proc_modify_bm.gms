$title LogMIP User's Manual Example 3 - Synthesis of 12 Processe (LOGMIP3,SEQ=336)
$ontext
...
$offtext
 ...
 SETS   J      PROCESS STREAMS                 / 1*32 /
        I      PROCESS UNITS                   / 1*12 /
...
* ---------------------------------------
            ...
            T104
            T105
            T111     INPUT-OUTPUT RELATIONS FOR PROCESS UNIT 11
            T112
            T113
            T114
            T115
            T121     INPUT-OUTPUT RELATIONS FOR PROCESS UNIT 12
            T122
            T123
            T124
            T125
...
T111..  EXP(X('32')) -1. =L= X('7')     ;
T114..  C('11') =G= 3                   ;
T115..  C('11') =L= 3                   ;
T112..  X('7') =L= 0                    ;
T113..  X('32') =L= 0                   ;

T121..  EXP(X('31')/1.1) -1. =L= X('30')     ;
T124..  C('12') =G= 7                        ;
T125..  C('12') =L= 7                        ;
T122..  X('30') =L= 0                        ;
T123..  X('31') =L= 0                        ;
...
equations c1, c2, c3, c4, c5, c6, c7, c8,
 ...
 C2.. Y('4') + Y('5') + Y('10') =l=1;
 C3.. Y('6') + Y('7') + Y('9') =l=1;
 C4.. (1-Y('1')) + Y('3') + Y('4') + Y('5') + Y('10') + Y('11') =g=1;
 C5.. (1-Y('2')) + Y('3') + Y('4') + Y('5') + Y('10') + Y('11') =g=1;
 C6.. (1-Y('3')) + Y('8') =g=1;
 C7.. (1-Y('3')) + Y('1') + Y('2') + Y('12') =g=1;
 C8.. (1-Y('4')) + Y('1') + Y('2') + Y('12') =g=1;
 C9.. (1-Y('4')) + Y('6') + Y('7') + Y('9') =g=1;
 C10.. (1-Y('5')) + Y('1') + Y('2') + Y('12') =g=1;
 C11.. (1-Y('5')) + Y('8') =g=1;
 C12.. (1-Y('6')) + Y('4') =g=1;
 C13.. (1-Y('7')) + Y('4') =g=1;
 C14.. (1-Y('10')) + Y('1') + Y('2') + Y('12') =g=1;
 C15.. (1-Y('9')) + Y('4') =g=1;
 C16.. (1-Y('12')) + Y('3') + Y('4') + Y('5') + Y('10') + Y('11') =g=1;
 C17.. (1-Y('11')) + Y('1') + Y('2') + Y('12') =g=1;
 C18.. Y('3') + Y('11') =l=1;

MODEL PROC12 / ALL / ;

file emp / "%emp.info%" /; put emp '*--- start EMP  %gams.i%'; emp.silent=0;

put / "disjunction   bigM 7 Y('1')" T11.tn " "T14.tn " "T15.tn
    / "     else     " T12.tn " "T13.tn ;

put / "disjunction   bigM 7 Y('2') " T21.tn " "T24.tn " "T25.tn
    / "     else      " T22.tn " "T23.tn ;

put / "disjunction   bigM 7 Y('3') " T31.tn " "T35.tn " "T36.tn
    / "     else      " T32.tn " "T33.tn " "T34.tn ;

put / "disjunction   bigM 7 Y('4') " T41.tn " "T45.tn " "T46.tn
    / "     else      " T42.tn " "T43.tn " "T44.tn ;

put / "disjunction   bigM 7 Y('5') " T51.tn " "T54.tn " "T55.tn
    / "     else      " T52.tn " "T53.tn ;

put / "disjunction   bigM 7 Y('6') " T61.tn " "T64.tn " "T65.tn
    / "     else      " T62.tn " "T63.tn ;

put / "disjunction   bigM 7 Y('7') " T71.tn " "T74.tn " "T75.tn
    / "     else      " T72.tn " "T73.tn ;

put / "disjunction   bigM 7 Y('8') " T81.tn " "T85.tn " "T86.tn
    / "     else      " T82.tn " "T83.tn " "T84.tn ;

put / "disjunction   bigM 7 Y('9') " T91.tn " "T94.tn " "T95.tn
    / "     else      " T92.tn " "T93.tn ;

put / "disjunction   bigM 7 Y('10') " T101.tn " "T104.tn " "T105.tn
    / "     else      " T102.tn " "T103.tn ;

put / "disjunction   bigM 7 Y('11') " T111.tn " "T114.tn " "T115.tn
    / "     else      " T112.tn " "T113.tn ;

put / "disjunction   bigM 7 Y('12') " T121.tn " "T124.tn " "T125.tn
    / "     else      " T122.tn " "T123.tn ;
...
SOLVE PROC12 USING emp MINIMIZING TOTAL_COST;
