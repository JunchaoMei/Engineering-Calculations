...
Logic Equations L1,L2,L3,IL1,IL2,IL3,IL4,IL5,IL6,IL7,IL8,IL9,IL10;
L1..  not(Y('1')and Y('2'));
L2..  not(Y('4')and Y('5'));
L3..  not(Y('6')and Y('7'));
IL1.. bool_imp(Y('1'),Y('3') or Y('4') or Y('5'));
IL2.. bool_imp(Y('2'),Y('3') or Y('4') or Y('5'));
IL3.. bool_imp(Y('3'),Y('8'));
IL4.. bool_imp(Y('3'),Y('1') or Y('2'));
IL5.. bool_imp(Y('4'),Y('1') or Y('2'));
IL6.. bool_imp(Y('4'),Y('6') or Y('7'));
