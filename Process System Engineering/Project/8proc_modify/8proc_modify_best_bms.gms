...
put / "disjunction   bigM 6.4 Y('1')" T11.tn " "T14.tn
    / "     else     " T12.tn " "T13.tn ;

put / "disjunction   bigM 4.3 Y('2') " T21.tn " "T24.tn
    / "     else      " T22.tn " "T23.tn ;

put / "disjunction   bigM 3 Y('3') " T31.tn " "T35.tn
    / "     else      " T32.tn " "T33.tn " "T34.tn ;

put / "disjunction   bigM 3.4 Y('4') " T41.tn " "T45.tn
    / "     else      " T42.tn " "T43.tn " "T44.tn ;

put / "disjunction   bigM 10 Y('5') " T51.tn " "T54.tn
    / "     else      " T52.tn " "T53.tn ;

put / "disjunction   bigM 27.1 Y('6') " T61.tn " "T64.tn
    / "     else      " T62.tn " "T63.tn ;

put / "disjunction   bigM 150 Y('7') " T71.tn " "T74.tn
    / "     else      " T72.tn " "T73.tn ;

put / "disjunction   bigM 150 Y('8') " T81.tn " "T85.tn
...
SOLVE PROC8 USING emp MINIMIZING TOTAL_COST;
