...
option limrow=0;
option limcol=0;
file output /"gamsoutput12.txt"/;
file emp / "%emp.info%" /;
output.ap=1;

for(scalarq= 6.5 downto 6.3 by 0.02,
Mtry=scalarq;
...
put / "disjunction   bigM" Mtry "Y('11') " T111.tn " "T114.tn " "T115.tn
    / "     else      " T112.tn " "T113.tn ;

put / "disjunction   bigM" Mtry "Y('12') " T121.tn " "T124.tn " "T125.tn
...
put output  Mtry:10:3, TOTAL_COST.l:10:4 PROC10.solvestat:2:0 / ;
