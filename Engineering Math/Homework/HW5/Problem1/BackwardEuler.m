...
for i=1:N
    ...
    while abs(diff)>0.001
        F = [Ynr1(1)-Y(1,i)+h*(k1*Ynr1(1)^2+k3*Ynr1(1)^2);
             Ynr1(2)-Y(2,i)-h*(k1*Ynr1(1)^2-k2*Ynr1(2));
             Ynr1(3)-Y(3,i)-h*(k3*Ynr1(1)^2+k2*Ynr1(2))];
        J = [1+2*h*(k1+k3)*Ynr1(1),0,0;
             -2*h*k1*Ynr1(1),1+k2*h,0;
             -2*h*k3*Ynr1(1),-k2*h,1];
        Ynr2 = Ynr1-inv(J)*F;
        diff = (Ynr2-Ynr1)./Ynr2;
        Ynr1 = Ynr2;
    end
